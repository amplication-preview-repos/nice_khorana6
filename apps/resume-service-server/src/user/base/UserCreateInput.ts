...
class UserCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ResumeSectionCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => ResumeSectionCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => ResumeSectionCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => DashboardSettingsCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => DashboardSettingsCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => DashboardSettingsCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
